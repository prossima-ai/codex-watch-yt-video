...
Validate one source, inventory native VTT and TTML captions, and prepare normalized transcript evidence through the bundled runtime. Visual coverage remains `none` until the visual-evidence stage exists.
